...
//     // If backend mistakenly wraps it in { question: [...] }
...
//               {isLastQuestion ? (
//                 <Button onClick={handleSubmit} disabled={isSubmitting || selectedAnswers[currentQuestionIndex] === null} className="bg-gradient-success hover:opacity-90 text-white font-medium flex items-center gap-2">
//                   {isSubmitting ? "Submitting..." : "Submit Quiz"} <BookOpen className="w-4 h-4" />
//                 </Button>
//               ) : (
//                 <Button onClick={handleNext} disabled={selectedAnswers[currentQuestionIndex] === null} className="bg-gradient-primary hover:opacity-90 text-white flex items-center gap-2">
